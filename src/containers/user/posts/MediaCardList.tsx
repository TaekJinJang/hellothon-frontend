...
function MediaCardList({ mediaList }: MediaCardListProps) {
  return (
    <div className="flex gap-4 pb-4 overflow-x-auto w-full">
      {mediaList.map((media, index) => (
        <Card key={index} className="bg-white shadow-md rounded-md w-[180px] h-[360px] flex flex-col justify-between">
