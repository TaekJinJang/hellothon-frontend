    ...
    <div className="flex flex-col gap-6">
      {[...Array(count)].map((_, idx) => (
        <div key={idx} className="border rounded-lg shadow-md p-4 animate-pulse">
          ...
          <div className="border-b pb-4 mb-4">
            <div className="h-4 w-1/3 bg-gray-200 rounded-md mb-2"></div> {/* 사용자명 스켈레톤 */}
            <div className="h-4 w-full bg-gray-200 rounded-md mb-2"></div> {/* 댓글 내용 스켈레톤 */}
            <div className="h-4 w-1/4 bg-gray-200 rounded-md"></div> {/* 날짜 스켈레톤 */}
          </div>

          {/* 추천 답글이 있을 때 보여지는 스켈레톤 */}
          <div className="pt-4 pb-2">
            <div className="flex items-center text-slate-800 font-semibold mb-2">
              <div className="h-4 w-1/5 bg-gray-200 rounded-md flex items-center gap-2">
                <div className="h-4 w-4 bg-gray-300 rounded-md"></div> {/* 아이콘 자리 */}
                <div className="h-4 w-3/5 bg-gray-200 rounded-md"></div> {/* 추천 답글 텍스트 */}
              </div>
            </div>
          </div>
          ...
          {/* 추천 답글 본문 및 복사 버튼 */}
          <div className="border rounded-md p-4 bg-slate-50 flex justify-between items-start">
            <div className="h-4 w-3/4 bg-gray-200 rounded-md"></div> {/* 추천 답글 텍스트 */}
